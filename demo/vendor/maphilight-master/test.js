    ...
    if (c = !!document.createElement("canvas").getContext, l = function() {
        ...
        if (c) {
            ...
            p = function(t, i, e, a, o) {
                ...
                r.save(), b(r, i, e), a.fill && (r.fillStyle = v(a.fillColor, a.fillOpacity), r.fill()), a.stroke && (r.strokeStyle = v(a.strokeColor, a.strokeOpacity), r.lineWidth = a.strokeWidth, r.stroke()), r.restore(), a.fade && d(t).css("opacity", 0).animate({
                    opacity: 1
                }, 100)
            }, u = function(t) {
